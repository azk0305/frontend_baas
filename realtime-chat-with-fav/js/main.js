...
// 「お気に入り」ルームの名前
var favoritesRoomName = "favorites";
...
function loadChatView() {
  ...
  favoritesRef.on("child_removed", function(favSnapshot) {
    ...
    // お気に入りリンクの glyphicon を glyphicon-star-empty に変更する
    $("#message-id-" + messageId).find(".message__favorite-link")
                                 .find(".glyphicon")
  ...
  favoritesRef.on("child_added", function(favSnapshot) {
    ...
    // お気に入りリンクの glyphicon を glyphicon-star に変更する
    $("#message-id-" + messageId).find(".message__favorite-link")
                                 .find(".glyphicon")
...
function createMessageDiv(messageId, message) {
  ...
  if(dbdata.favorites && dbdata.favorites[messageId]) {
    // お気に入りON（glyphicon-star）
    mfl.find(".glyphicon").removeClass("glyphicon-star-empty").addClass("glyphicon-star");
  } else {
    // お気に入りOFF（glyphicon-star-empty）
    mfl.find(".glyphicon").removeClass("glyphicon-star").addClass("glyphicon-star-empty");
  }
